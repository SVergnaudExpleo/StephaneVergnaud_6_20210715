          ...
          <form data-testid="form-new-bill">
            <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="col-half">
                    <label for="datepicker" class="bold-label" data-testid="datepicker">Date</label>
                    <input required type="date" id="datepicker" class="form-control blue-border" data-testid="datepickerinput" />
                  </div>
                  <div class="col-half">
